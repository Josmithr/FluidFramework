...
API documentation for **@fluidframework/runtime-definitions** is available at [https://fluidframework.com/docs/apis/runtime-definitions](https://fluidframework.com/docs/apis/runtime-definitions).
