...
API documentation for **@fluidframework/container-runtime** is available at [https://fluidframework.com/docs/apis/container-runtime](https://fluidframework.com/docs/apis/container-runtime).
