...
```bash
npm i @fluidframework/quill-react
```
...
To access the `public` ([SemVer](https://semver.org/)) APIs, import via `@fluidframework/quill-react` like normal.

To access the `beta` APIs, import via `@fluidframework/quill-react/beta`.

To access the `alpha` APIs, import via `@fluidframework/quill-react/alpha`.
