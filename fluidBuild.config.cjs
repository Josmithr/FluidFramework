	...
	policy: {
		...
		handlerExclusions: {
			...
			"npm-package-api-reports-match-entrypoints": [
				...
				// Published test workloads do not expose reusable API entrypoints.
				...
				"^packages/test/test-service-load/package.json$",
				// Published executable and configuration packages do not expose declaration contracts.
				"^azure/packages/azure-local-service/package.json$",
				...
				"^server/routerlicious/packages/routerlicious/package.json$",
				// API Extractor 7.58.1 crashes while analyzing this package's generated API declaration.
