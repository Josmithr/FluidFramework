...
| [inherited-accessors-base.ts](inherited-accessors-base.ts), [inherited-accessors.ts](inherited-accessors.ts), and [inherited-accessors-consumer.ts](inherited-accessors-consumer.ts) | TS6/TS7 producers and consumers verify generic getter/setter views, read-only and write-only accessors, protected/private visibility, local overrides, original documentation identities, model corruption rejection, and the distinct generic setter heritage fallback. |
