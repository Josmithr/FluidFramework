...
- A package-wide function-name audit replaced noun-style implementation and test helpers with verb phrases through semantic renames. Compiler fixture API names remain unchanged because they are test inputs. Member/container release-level policy remains pending discussion.
